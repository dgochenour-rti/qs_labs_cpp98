...
namespace qs {
    ...
    * -------------------------------------------------------------------------- */
        ...
        const struct DDS_TypeAllocationParams_t * alloc_params) 
    {
        ...
        sample = new (std::nothrow) qs_type ;
        if (sample == NULL) {
            return NULL;
        }

        if (!qs::qs_type_initialize_w_params(sample,alloc_params)) {
            delete  sample;
            sample=NULL;
        }
        return sample; 
    ...
    qs_typePluginSupport_create_data_ex(RTIBool allocate_pointers) 
    {
        ...
        if (!qs::qs_type_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
            delete  sample;
            sample=NULL;
        }
    ...
    {
        return qs::qs_typePluginSupport_create_data_ex(RTI_TRUE);
    }
    ...
    qs_typePluginSupport_destroy_data_w_params(
        ...
        qs::qs_type_finalize_w_params(sample,dealloc_params);
    ...
    qs_typePluginSupport_destroy_data_ex(
        ...
        qs::qs_type_finalize_ex(sample,deallocate_pointers);
    ...
    qs_typePluginSupport_destroy_data(
        ...
        qs::qs_typePluginSupport_destroy_data_ex(sample,RTI_TRUE);
    ...
    qs_typePluginSupport_copy_data(
        ...
        const qs_type *src)
    {
        return qs::qs_type_copy(dst,(const qs_type*) src);
    }
        ...
        unsigned int indent_level)
    {
        ...
        RTICdrType_printBoolean(
            &sample->condition1, "condition1", indent_level + 1);    
    ...
    qs_typePluginSupport_create_key_ex(RTIBool allocate_pointers){
        ...
        key = new (std::nothrow) qs_typeKeyHolder ;

        qs::qs_type_initialize_ex(key,allocate_pointers, RTI_TRUE);
    ...
    {
        return  qs::qs_typePluginSupport_create_key_ex(RTI_TRUE);
    }
    ...
    {
        qs::qs_type_finalize_ex(key,deallocate_pointers);
    ...
    qs_typePluginSupport_destroy_key(
        ...
        qs::qs_typePluginSupport_destroy_key_ex(key,RTI_TRUE);
    ...
    * ---------------------------------------------------------------------------- */
        ...
        void *handle)
    {
        ...
        qs_type_finalize_optional_members(sample, RTI_TRUE);
    ...
    * ------------------------------------------------------------------------- */
        ...
        void *endpoint_plugin_qos)
    {
        ...
        try {
            ...
            if(deserialize_sample) {
                ...
                qs::qs_type_initialize_ex(sample, RTI_FALSE, RTI_FALSE);
                ...
                if (!RTICdrStream_deserializeStringEx(
                    stream,&sample->name, (128) + 1, RTI_FALSE)) {
                    goto fin; 
                }
            }
        ...
        const struct DDS_PrintFormatProperty *property)
    {
        ...
        if (!qs_typePlugin_serialize_to_cdr_buffer(
            NULL, 
            &length, 
            sample)) {
    ...
    * ------------------------------------------------------------------------ */
    ...
    { 
        ...
        qs_type_finalize_optional_members;
        ...
        plugin->typeCode =  (struct RTICdrTypeCode *)qs::qs_type_get_typecode();
        ...
        plugin->endpointTypeName = qs_typeTYPENAME;
